export default {
  ...
  // History
  history: {
    sortByOccurredAt: "Par date",
    sortByUpdatedAt: "Par dernière modification",
    endOfList: "C'est tout",
  },
  ...
  transactions: {
    ...
    enterAmount: "Entrez le montant",
    chooseSpendingCategory: "Choisissez une catégorie de dépenses",
