export default {
  ...
  statistics: {
    ...
    spending: "खर्च",
    spendingToday: "आज का खर्च",
    spendingYesterday: "कल का खर्च",
    spendingOnDate: "{{date}} का खर्च",
    totalToday: "आज कुल",
    totalYesterday: "कल कुल",
    totalOnDate: "{{date}} कुल",
    totalThisWeek: "इस सप्ताह कुल",
    totalLastWeek: "पिछले सप्ताह कुल",
    totalWeekRange: "{{range}} कुल",
    average: "औसत",
    ...
    totalThisYear: "इस वर्ष कुल",
    totalLastYear: "पिछले वर्ष कुल",
    totalForYear: "{{year}} कुल",
    monthlyAverage: "मासिक औसत",
    fromLastYear: "पिछले वर्ष से",
    weekShort: "स{{number}}",
